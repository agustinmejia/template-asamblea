...
@section('seo')
    <title>Comisión de Desarrollo Humano - ALDB</title>
    ...
    <meta property="og:image"         content="{{ asset('assets/img/comisiones/desarrollo_humano.jpg') }}" />
@endsection
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        ...
        <div class="container" style="position: absolute; z-index: 10; padding: 15px">
            <ol>
                ...
                <li class="text-white">Comisión de Desarrollo Humano</li>
            </ol>
            <br>
            <h3 class="text-white">Comisión de Desarrollo Humano</h3>
            {{-- <br> --}}
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-right">
                                <h3>Comisión de Desarrollo Humano</h3>
                                ...
                                <ul>
                                    <li>Educación, Salud, Deportes y Recreación.</li>
                                    <li>Cultura y Patrimonio Cultural.</li>
                                    <li>Seguridad y Protección Social.</li>
                                    <li>Niña, Niño y Adolescencia, Adulto Mayor y Personas con Discapacidad.</li>
                                    <li>Vivienda y Servicios Básicos.</li>
                                    <li>Sectores Sociales Vulnerables.</li>
                                    <li>Género y Generacional.</li>
                                </ul>
                            </div>
                            <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left">
                                <img src="{{ asset('assets/img/comisiones/desarrollo_humano.jpg') }}" class="img-fluid" alt="">
                            </div>
                        </div>
