...
@section('seo')
    <title>Comisión de Derechos Humanos - ALDB</title>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        ...
        <div class="container" style="position: absolute; z-index: 10; padding: 15px">
            <ol>
                ...
                <li class="text-white">Comisión de Derechos Humanos</li>
            </ol>
            <br>
            <h3 class="text-white">Comisión de Derechos Humanos</h3>
            {{-- <br> --}}
                        ...
                        <div class="row">
                            <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-right">
                                ...
                                <ul>
                                    ...
                                    <li>Derechos Humanos e Igualdad de Oportunidades.</li>
                                    <li>Gestión territorial  indígena.</li>
                                </ul>
                            </div>
                            <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left">
                                <img src="{{ asset('assets/img/comisiones/derechos_humanos.jpg') }}" class="img-fluid" alt="">
                            </div>
                        </div>
