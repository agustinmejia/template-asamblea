...
@section('seo')
    <title>Comisión Relaciones Internacionales - ALDB</title>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        ...
        <div class="container" style="position: absolute; z-index: 10; padding: 15px">
            <ol>
                ...
                <li class="text-white">Comisión Relaciones Internacionales</li>
            </ol>
            <br>
            <h3 class="text-white">Comisión Relaciones Internacionales</h3>
            {{-- <br> --}}
