...
@section('seo')
    <title>Comisión de Relaciones Internacionales - ALDB</title>
    ...
    <meta property="og:image"         content="{{ asset('assets/img/comisiones/realaciones_internacionales.jpg') }}" />
@endsection
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        ...
        <div class="container" style="position: absolute; z-index: 10; padding: 15px">
            <ol>
                ...
                <li class="text-white">Comisión de Relaciones Internacionales</li>
            </ol>
            <br>
            <h3 class="text-white">Comisión de Relaciones Internacionales</h3>
            {{-- <br> --}}
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-right">
                                <h3>Comisión de Relaciones Internacionales</h3>
                                ...
                                <p style="text-align: justify !important">A continuación, se citan los aspectos que les corresponden conocer:</p>
                                <ul>
                                    <li>Asuntos limítrofes y delimitación departamental.</li>
                                    <li>Normas de desarrollo competencial.</li>
                                    <li>Movilidad competencial .</li>
                                    <li>Instrumentos autonómicos internacionales.</li>
                                    <li>Relacionamiento internacional del GAD Beni.</li>
                                </ul>
                            </div>
                            <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left">
                                <img src="{{ asset('assets/img/comisiones/realaciones_internacionales.jpg') }}" class="img-fluid" alt="">
                            </div>
                        </div>
